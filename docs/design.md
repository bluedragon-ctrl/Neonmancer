...
| `data/defs.json` | Object types and their defaults (`crate`: pushable, lime, inset mark, tinted faces; box variants `crate_plain`, `crate_inset_dark`, `crate_cross`, `crate_brackets`, `crate_dashed`, `crate_dashed_tinted`) |

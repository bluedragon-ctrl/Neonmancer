...
import { bodyBox, touchesCell } from '../src/physics/collision.js';
...
test('touchesCell: standing on or leaning against a cell counts, a corner or a gap does not', () => {
  const g = grid({ typedCells: { hazard: [[3, 0, 3]] } });
  const touches = (pos) => touchesCell(bodyBox(pos, [0.6, 1.5, 0.6]), g, CELL.hazard);
